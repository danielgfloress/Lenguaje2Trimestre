document.addEventListener("DOMContentLoaded", () => {
    const jugadores = {
        ...
        sol: { name: "Sol D.", gender: "♂", level: 17, img: "images/CartaSol.png", pe: 35, peMax: 60, pt: 30, ptMax: 65, stats: { tiro: 31, fisico: 28, control: 49, defensa: 24, rapidez: 30, valor: 29 }, tecnicas: ["Llamarada Solar", "Tormenata Eléctrica", "Avance Chispeante", "Cañon de Meteoritos"] },
        byron: { name: "Byron L.", gender: "♂", level: 16, img: "images/CartaByron.png", pe: 33, peMax: 55, pt: 28, ptMax: 60, stats: { tiro: 29, fisico: 27, control: 28, defensa: 22, rapidez: 27, valor: 25 }, tecnicas: ["Sabiduría Divina", "Vuelo de Ícaro", "Hora Celestial", "Remate Caótico"] },
        hiroto: { name: "Hiroto", gender: "♂", level: 17, img: "images/CartaHiroto.png", pe: 36, peMax: 58, pt: 34, ptMax: 70, stats: { tiro: 30, fisico: 29, control: 31, defensa: 25, rapidez: 28, valor: 27 }, tecnicas: ["Detonador", "Pingüino Ángel y Demonio"] },
        terry: { name: "Terry A.", gender: "♂", level: 14, img: "images/CartaTerry.png", pe: 28, peMax: 50, pt: 24, ptMax: 55, stats: { tiro: 25, fisico: 23, control: 24, defensa: 20, rapidez: 22, valor: 23 }, tecnicas: ["Parada en Mate", "Mate del dragón", "Tótem"] },
        nathan: { name: "Nathan S.", gender: "♂", level: 14, img: "images/CartaNathan.png", pe: 27, peMax: 50, pt: 22, ptMax: 55, stats: { tiro: 24, fisico: 22, control: 23, defensa: 21, rapidez: 43, valor: 21 }, tecnicas: ["Danza del Viento", "El Huracán", "Pájaro de Fuego"] },
        goldie: { name: "Goldie L.", gender: "♂", level: 15, img: "images/CartaGoldie.png", pe: 30, peMax: 55, pt: 26, ptMax: 60, stats: { tiro: 28, fisico: 26, control: 25, defensa: 22, rapidez: 27, valor: 24 }, tecnicas: ["Grumo Pegapasta", "Tornado de Fuego DT", "Miximax: Reina Dragones"] },
        arion: { name: "Arion S.", gender: "♂", level: 15, img: "images/CartaArion.png", pe: 29, peMax: 55, pt: 25, ptMax: 60, stats: { tiro: 27, fisico: 25, control: 26, defensa: 21, rapidez: 26, valor: 23 }, tecnicas: ["Tiro Vendaval", "Brisa Deslizante", "Robo Fantástico", "Tótem"] },
        fei: { name: "Fei R.", gender: "♂", level: 15, img: "images/CartaFei.png", pe: 28, peMax: 50, pt: 24, ptMax: 55, stats: { tiro: 26, fisico: 23, control: 25, defensa: 22, rapidez: 25, valor: 22 }, tecnicas: ["Tiro Rebotado", "Ultraluna", "Pasos Aéreos", "Miximax: T-Rex"] }
    };
